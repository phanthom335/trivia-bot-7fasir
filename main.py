    ...
    Trivia Bot 7fasir
    =================
    Zero-dependency terminal game where players challenge challenges in real time.
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Zero-dependency terminal game where players challenge challenges in real time.")
